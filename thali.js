async function fetchThaliData(file, containerId) {
    try {
        const response = await fetch(`json/${file}`); // Fetching data from the JSON file
        const data = await response.json();
        populateMenu(data, containerId); // Using the populateMenu function
    } catch (error) {
...
// Fetch data for vegetarian and non-vegetarian thali sections
fetchThaliData("thali_veg.json", "veg-thali");
fetchThaliData("thali_non_veg.json", "nonveg-thali");
